...
import me.skriva.ceph.crypto.axolotl.BrokenSessionException;
import me.skriva.ceph.crypto.axolotl.NotEncryptedForThisDeviceException;
...
public class MessageParser extends AbstractParser implements OnMessagePacketReceived {
    ...
    public void onMessagePacketReceived(Account account, MessagePacket original) {
        ...
        if ((body != null || (axolotlEncrypted != null && axolotlEncrypted.hasChild("payload")) || oobUrl != null || xP1S3 != null) && !isMucStatusMessage || messageReference != null) {
            ...
            if (message.getEncryption() == Message.ENCRYPTION_AXOLOTL_NOT_FOR_THIS_DEVICE || message.getEncryption() == Message.ENCRYPTION_AXOLOTL_FAILED) {
                notify = false;
            }

...
import me.skriva.ceph.crypto.axolotl.SQLiteAxolotlStore;
...
import me.skriva.ceph.services.ShortcutService;
...
public class DatabaseBackend extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 34 && newVersion >= 34) {
            ...
            final File oldPicturesDirectory = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/Skriva/");
            final File oldFilesDirectory = new File(Environment.getExternalStorageDirectory() + "/Skriva/");
            final File newFilesDirectory = new File(Environment.getExternalStorageDirectory() + "/Skriva/Media/Skriva Files/");
            final File newVideosDirectory = new File(Environment.getExternalStorageDirectory() + "/Skriva/Media/Skriva Videos/");
            if (oldPicturesDirectory.exists() && oldPicturesDirectory.isDirectory()) {
                final File newPicturesDirectory = new File(Environment.getExternalStorageDirectory() + "/Skriva/Media/Skriva Images/");

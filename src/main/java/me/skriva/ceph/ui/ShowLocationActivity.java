...
import me.skriva.ceph.databinding.ActivityShowLocationBinding;
import me.skriva.ceph.ui.util.LocationHelper;
import me.skriva.ceph.ui.util.UriHelper;
import me.skriva.ceph.ui.widget.Marker;
import me.skriva.ceph.ui.widget.MyLocation;
import me.skriva.ceph.utils.LocationProvider;
...
public class ShowLocationActivity extends LocationActivity implements LocationListener {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			switch (action) {
				case "me.skriva.ceph.location.show":

...
import me.skriva.ceph.utils.BackupFileHeader;
import me.skriva.ceph.utils.Compatibility;
import me.skriva.ceph.utils.SerialSingleThreadExecutor;
import rocks.xmpp.addr.Jid;

import static me.skriva.ceph.services.ExportBackupService.CIPHERMODE;
import static me.skriva.ceph.services.ExportBackupService.KEYTYPE;
import static me.skriva.ceph.services.ExportBackupService.PROVIDER;
...
public class ImportBackupService extends Service {
    ...
    public void loadBackupFiles(OnBackupFilesLoaded onBackupFilesLoaded) {
        executor.execute(() -> {
            ...
            final Set<String> apps = new HashSet<>(Collections.singletonList("Skriva"));
            for (String app : apps) {
